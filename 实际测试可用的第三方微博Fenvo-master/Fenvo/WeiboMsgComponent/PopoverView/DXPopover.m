...
- (void)show
{
    ...
    //[self.containerView insertSubview:self atIndex:1];
    [self.containerView bringSubviewToFront:self.containerView.subviews[1]];
...
//        [UIView animateWithDuration:self.animationIn delay:0 options:UIViewAnimationOptionTransitionCurlUp animations:^{
//            self.transform = CGAffineTransformIdentity;
//        } completion:^(BOOL finished) {
//            if (finished) {
//                if (self.didShowHandler) {
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *contentColor = self.contentColor ? : [UIColor whiteColor];
