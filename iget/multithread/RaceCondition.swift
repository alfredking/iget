...
//p160 竞态条件  https://www.jianshu.com/p/7c5ff2608c83
...
//    }
    ...
    //串行队列异步  http://www.cocoachina.com/articles/26856
    ...
    func setUser(_user:User,completion :@escaping () -> Void) {
...
//    }
//
//    func setUser(_user:User,completion :@escaping (Result<()>) -> Void) {
//
//
...
//    }
    ...
    func storageSetUser(_user:User)
    {
        ...
        //存储Data对象
        UserDefaults.standard.set(modelData, forKey: _user.id!)
...
//
//    }
    //as? 向下转型，不成功会返回一个nil https://www.cnblogs.com/dukework/p/6553714.html
