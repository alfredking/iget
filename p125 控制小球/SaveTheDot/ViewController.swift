...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    animator = UIViewPropertyAnimator.init(duration: 2, curve: .easeOut, animations: {
        self.playerView.frame = self.playerView.frame.offsetBy(dx: 50, dy: 0)
    })
...
//
//        self.playerView.frame = self.playerView.frame.offsetBy(dx: 200, dy: 0)
//
//    }
...
//    animation.fromValue = self.playerView.center.y
//    animation.toValue = self.playerView.center.y + 200
