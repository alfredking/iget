...
#define NorthForwardwapURL @"http://www.cmpassport.com/openapi/NorthForwardServlet"
#define domainWapURL @"http://wap.cmpassport.com:8080/client/authRequest"
#define domainURL @"http://218.205.115.245:"
#define domainPort @"10090"
...
//测试
//#define NorthForwardwapURL @"http://218.205.115.243:10089/client/authRequest"
//#define domainWapURL @"http://218.205.115.243:10089/client/authRequest"
//#define domainURL @"http://218.205.115.243:"
//#define domainPort @"10089"
...
#define PIECEURL(suburl) [currentDomain boolValue]  ? [NSString stringWithFormat:@"%@%@%@",domainURL,domainPort,suburl]:[NSString stringWithFormat:@"%@%@%@",ipURL,ipPort,suburl]
...
#define sdkversionValue @"andidmp-iosv1.12.2"
