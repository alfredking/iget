...
//        _tableV = [[UITableView alloc]init];
//        _tableV.center = self.view.center;
//        //        _tableV.bounds = CGRectMake(0, 0, self.bounds.size.width/2, self.bounds.size.height/2);
//        _tableV.rowHeight = 30.0;
//        _tableV.delegate = self;
//        _tableV.dataSource = self;
//        _tableV.layer.cornerRadius = 5;
...
{
//    _userInfoArr = [[NSUserDefaults standardUserDefaults]objectForKey:userList];
