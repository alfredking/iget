...
-(void)checkToken:(NSString *)Token successBlock:(callBackBlock)success failBlock:(callBackBlock)fail
{
    ...
    NSMutableDictionary *head = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"1.0",@"version",@"5",@"apptype",currentDateStr,@"systemtime",msgid,@"msgid",sourceId,@"sourceid" , @"4e2c4b18c2504b83a28224677ce51119", @"sourcekey", nil];
//    NSMutableDictionary *user = [NSMutableDictionary dictionaryWithDictionary:(NSDictionary *)[userInfoStorage getInfoWithKey:@"18867101271"]];
