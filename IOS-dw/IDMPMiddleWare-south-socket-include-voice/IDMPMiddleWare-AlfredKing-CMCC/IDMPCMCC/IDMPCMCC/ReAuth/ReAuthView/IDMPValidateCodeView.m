...
- (instancetype)init {
    if (self = [super init]) {
        ...
        for (int i=0; i<4; i++) {
            ...
            lbl.layer.borderColor = i==0 ? [[UIColor colorWithHex:0x1979bc] CGColor] : [[UIColor colorWithHex:0xa6a6a6] CGColor];
...
- (void)clearText {
    ...
    for (int i=0; i<self.pincodeArrayTF.count; i++) {
        ...
        if (i != 0) {
            self.pincodeArrayTF[i].layer.borderColor = [[UIColor colorWithHex:0xa6a6a6] CGColor];
        }
    }
}
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (count <= self.pincodeArrayTF.count) {
        ...
        self.pincodeArrayTF[count - 1].layer.borderColor = [string isEqualToString:@""] ? [[UIColor colorWithHex:0xa6a6a6] CGColor] : [[UIColor colorWithHex:0x1979bc] CGColor];
