...
#ifndef IDMPGCDAsyncSocketLoggingEnabled
#define IDMPGCDAsyncSocketLoggingEnabled 0
#endif

#if IDMPGCDAsyncSocketLoggingEnabled
...
#ifndef IDMPGCDAsyncSocketLogLevel
#define IDMPGCDAsyncSocketLogLevel LOG_LEVEL_VERBOSE
#endif

// Log levels : off, error, warn, info, verbose
static const int logLevel = IDMPGCDAsyncSocketLogLevel;
...
NSString *const IDMPGCDAsyncSocketException = @"IDMPGCDAsyncSocketException";
NSString *const IDMPGCDAsyncSocketErrorDomain = @"IDMPGCDAsyncSocketErrorDomain";

NSString *const IDMPGCDAsyncSocketQueueName = @"IDMPGCDAsyncSocket";
NSString *const IDMPGCDAsyncSocketThreadName = @"IDMPGCDAsyncSocket-CFStream";

NSString *const IDMPGCDAsyncSocketManuallyEvaluateTrust = @"IDMPGCDAsyncSocketManuallyEvaluateTrust";
#if TARGET_OS_IPHONE
NSString *const IDMPGCDAsyncSocketUseCFStreamForTLS = @"IDMPGCDAsyncSocketUseCFStreamForTLS";
#endif
NSString *const IDMPGCDAsyncSocketSSLPeerID = @"IDMPGCDAsyncSocketSSLPeerID";
NSString *const IDMPGCDAsyncSocketSSLProtocolVersionMin = @"IDMPGCDAsyncSocketSSLProtocolVersionMin";
NSString *const IDMPGCDAsyncSocketSSLProtocolVersionMax = @"IDMPGCDAsyncSocketSSLProtocolVersionMax";
NSString *const IDMPGCDAsyncSocketSSLSessionOptionFalseStart = @"IDMPGCDAsyncSocketSSLSessionOptionFalseStart";
NSString *const IDMPGCDAsyncSocketSSLSessionOptionSendOneByteRecord = @"IDMPGCDAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const IDMPGCDAsyncSocketSSLCipherSuites = @"IDMPGCDAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const IDMPGCDAsyncSocketSSLDiffieHellmanParameters = @"IDMPGCDAsyncSocketSSLDiffieHellmanParameters";
#endif

enum IDMPGCDAsyncSocketFlags
{
...
@interface IDMPGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation IDMPGCDAsyncSocketPreBuffer
...
**/
@interface IDMPGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(IDMPGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation IDMPGCDAsyncReadPacket
...
**/
@interface IDMPGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation IDMPGCDAsyncWritePacket
...
**/
@interface IDMPGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation IDMPGCDAsyncSpecialPacket
...
@implementation IDMPGCDAsyncSocket
{
	uint32_t flags;
	uint16_t config;
	
	__weak id<IDMPGCDAsyncSocketDelegate> delegate;
	...
	IDMPGCDAsyncReadPacket *currentRead;
	IDMPGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	IDMPGCDAsyncSocketPreBuffer *preBuffer;
	...
	IDMPGCDAsyncSocketPreBuffer *sslPreBuffer;
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([IDMPGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[IDMPGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)getDelegate:(id<IDMPGCDAsyncSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
//    setsockopt(childSocketFD, SOL_SOCKET, SO_NOSIGPIPE, &nosigpipe, sizeof(nosigpipe));
    ...
    setsockopt(childSocketFD, IPPROTO_IP, IP_BOUND_IF, &index, sizeof(index));
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			IDMPGCDAsyncSocket *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
//    setsockopt(socketFD, SOL_SOCKET, SO_NOSIGPIPE, &nosigpipe, sizeof(nosigpipe));
    int index = if_nametoindex("pdp_ip0");
    int res = setsockopt(socketFD, IPPROTO_IP, IP_BOUND_IF, &index, sizeof(index));
    if (res == -1) {
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
- (NSError *)readMaxedOutError
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)readTimeoutError
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
- (NSError *)writeTimeoutError
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}
...
- (NSError *)connectionClosedError
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:IDMPGCDAsyncSocketErrorDomain code:IDMPGCDAsyncSocketOtherError userInfo:userInfo];
}
                        ...
                        tag:(long)tag
{
	...
	IDMPGCDAsyncReadPacket *packet = [[IDMPGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
        ...
        if (!self->currentRead || ![self->currentRead isKindOfClass:[IDMPGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[IDMPGCDAsyncSpecialPacket class]])
			{
...
- (void)completeCurrentRead
{
	...
	{
		IDMPGCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		IDMPGCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	IDMPGCDAsyncWritePacket *packet = [[IDMPGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
        ...
        if (!self->currentWrite || ![self->currentWrite isKindOfClass:[IDMPGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[IDMPGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GCDAsyncSpecialPacket");
...
- (void)doWriteTimeout
{
	...
	{
		IDMPGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	IDMPGCDAsyncSpecialPacket *packet = [[IDMPGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			IDMPGCDAsyncSpecialPacket *tlsPacket = (IDMPGCDAsyncSpecialPacket *)currentRead;
            NSDictionary *tlsSettings = @{};
            if (tlsPacket) {
                tlsSettings = tlsPacket->tlsSettings;
            }
			NSNumber *value = [tlsSettings objectForKey:IDMPGCDAsyncSocketUseCFStreamForTLS];
...
{
	IDMPGCDAsyncSocket *asyncSocket = (__bridge IDMPGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	BOOL shouldManuallyEvaluateTrust = [[tlsSettings objectForKey:IDMPGCDAsyncSocketManuallyEvaluateTrust] boolValue];
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLPeerID];
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLProtocolVersionMin];
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLProtocolVersionMax];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLSessionOptionFalseStart];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLSessionOptionSendOneByteRecord];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	value = [tlsSettings objectForKey:IDMPGCDAsyncSocketSSLCipherSuites];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	sslPreBuffer = [[IDMPGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[IDMPGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[IDMPGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:IDMPGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(IDMPGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(IDMPGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	IDMPGCDAsyncSocket *asyncSocket = (__bridge IDMPGCDAsyncSocket *)pInfo;
