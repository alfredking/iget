...
//
//
//  改造GCDAsyncSocket为IDMPGCDAsyncSocket，设置socket的接口只走cellular！！！
//
...
@class IDMPGCDAsyncReadPacket;
@class IDMPGCDAsyncWritePacket;
@class IDMPGCDAsyncSocketPreBuffer;
@protocol IDMPGCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const IDMPGCDAsyncSocketException;
extern NSString *const IDMPGCDAsyncSocketErrorDomain;

extern NSString *const IDMPGCDAsyncSocketQueueName;
extern NSString *const IDMPGCDAsyncSocketThreadName;

extern NSString *const IDMPGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const IDMPGCDAsyncSocketUseCFStreamForTLS;
#endif
#define IDMPGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define IDMPGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define IDMPGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const IDMPGCDAsyncSocketSSLPeerID;
extern NSString *const IDMPGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const IDMPGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const IDMPGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const IDMPGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const IDMPGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const IDMPGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define IDMPGCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, IDMPGCDAsyncSocketError) {
	IDMPGCDAsyncSocketNoError = 0,           // Never used
	IDMPGCDAsyncSocketBadConfigError,        // Invalid configuration
	IDMPGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	IDMPGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	IDMPGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	IDMPGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	IDMPGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	IDMPGCDAsyncSocketClosedError,           // The remote peer closed the connection
	IDMPGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface IDMPGCDAsyncSocket : NSObject
...
- (instancetype)initWithDelegate:(nullable id<IDMPGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<IDMPGCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<IDMPGCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<IDMPGCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<IDMPGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<IDMPGCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<IDMPGCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
@protocol IDMPGCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(IDMPGCDAsyncSocket *)sock;
...
**/
- (void)socket:(IDMPGCDAsyncSocket *)sock didAcceptNewSocket:(IDMPGCDAsyncSocket *)newSocket;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
**/
- (void)socket:(IDMPGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(IDMPGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(IDMPGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(IDMPGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(IDMPGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(IDMPGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(IDMPGCDAsyncSocket *)sock;
...
**/
- (void)socketDidDisconnect:(IDMPGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(IDMPGCDAsyncSocket *)sock;
...
**/
- (void)socket:(IDMPGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
