...
- (IBAction)registerAccount:(id)sender
{
    ...
    [idmp registerUserWithPhoneNo:self.phoneNumber.text passWord:self.passwordOrOld.text andValidCode:self.valid.text finishBlock:^(NSDictionary *paraments) {
...
{
    IDMPAutoLoginViewController *idmp = [IDMPAutoLoginViewController new];
    [idmp resetPasswordWithPhoneNo:self.phoneNumber.text passWord:self.passwordOrNew.text andValidCode:self.valid.text finishBlock:^(NSDictionary *paraments) {
        NSLog(@"success");
        NSLog(@"%@",paraments);
    } failBlock:^(NSDictionary *paraments) {
        NSLog(@"fail");
...
{
    IDMPAutoLoginViewController *idmp = [IDMPAutoLoginViewController new];
    [idmp changePasswordWithPhoneNo:self.phoneNumber.text passWord:self.passwordOrOld.text andNewPSW:self.passwordOrNew.text finishBlock:^(NSDictionary *paraments) {
