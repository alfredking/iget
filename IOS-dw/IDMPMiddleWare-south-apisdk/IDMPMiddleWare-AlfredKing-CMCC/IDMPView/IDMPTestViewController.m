...
//#define APPID  @"01000203"
//#define APPKEY @"D70038901F49D23D"
...
- (void)viewDidLoad {
    ...
    [IDMPAutoLoginViewController setEnvironment:DebugEnvironment];
    
    sdkCertIDTF.text = @"4e07d1f52fbf454c9fcfc0824a9af14d4352849031169";
    phoneNumberTF.text = @"13683329795";
}
...
//        }
        ...
        {
            NSString *message = [NSString stringWithFormat:@"获取token失败:%@",resultCode];
...
- (IBAction)logoutClick:(id)sender {
    ...
    [IDMPAutoLoginViewController logoutForcedWithUserName:phoneNumberTF.text];
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    if (timerStop == NO)
    {
        _timer = [NSTimer scheduledTimerWithTimeInterval:2.0f target:self selector:@selector(renewalAuthTokenClicked:) userInfo:nil repeats:YES];
        timerStop = YES;
    }
    else
    {
