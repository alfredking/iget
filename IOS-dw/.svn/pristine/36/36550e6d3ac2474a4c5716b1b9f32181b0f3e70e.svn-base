...
/**
 *  接口用于获取当前的网络状态。在主线程调用会有超时被系统强制结束造成应用崩溃的风险，需要在子线程中调用
 *
 *  @return 网络状态。“0”表示同时开启wifi和蜂窝网络；“1”表示只开启蜂窝网络；“2”表示连有wifi且有中国移动SIM卡，但没有开启蜂窝网络；“3”表示连有wifi，但没有有中国移动SIM卡和没有开启蜂窝网络；“-1”表示无网络。
 */
- (int)getAuthType;
