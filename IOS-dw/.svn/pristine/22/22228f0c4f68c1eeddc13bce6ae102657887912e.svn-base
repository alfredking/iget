    ...
    if(![ischecked isEqualToString:yesFlag])
    {
        ...
        finishBlock:^(NSDictionary *paraments)
        {
             @autoreleasepool
             {
                 ...
                 [self getSmsWithUserName:userName busiType:busiType successBlock:successBlock failBlock:failBlock];
             }
...
- (void)getSmsWithUserName:(NSString*)userName busiType:(NSString *)busiType successBlock:(accessBlock)successBlock failBlock:(accessBlock)failBlock
{
    NSDictionary *result;
