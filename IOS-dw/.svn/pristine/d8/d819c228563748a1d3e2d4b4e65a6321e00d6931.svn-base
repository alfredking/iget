...
void append(NSString *msg){
    ...
    NSString* lLogDir = [documentsDirectory stringByAppendingPathComponent:@"log"];
...
void _Logv(NSString *prefix, const char *file, int lineNumber, const char *funcName, NSString *format, va_list ap)
{
    ...
    fprintf(stdout,"%s %s%50s:%3d - %s",[[lDate descriptionWithLocale:[NSLocale autoupdatingCurrentLocale]] UTF8String],[prefix UTF8String], funcName, lineNumber, [msg UTF8String]);
    NSString* lFullMsg = [NSString stringWithFormat:@"%@ %@%50s:%3d - %@", [lDate descriptionWithLocale:[NSLocale autoupdatingCurrentLocale]], prefix, funcName, lineNumber, msg];
