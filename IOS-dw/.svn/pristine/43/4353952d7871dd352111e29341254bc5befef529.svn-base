 ...
 */
////https
//#define APPID @"01000148"
//#define APPKEY @"AF0AA31C36EBA559"


//updateks
//#define APPID @"10000035"
//
//#define APPKEY @"DE4AC5E125F177C5"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (!lastVersion)
    {
        ...
        [[IDMPAutoLoginViewController alloc] initWithAppid:APPID Appkey:APPKEY TimeoutInterval:20 finishBlock:^(NSDictionary *paraments) {
