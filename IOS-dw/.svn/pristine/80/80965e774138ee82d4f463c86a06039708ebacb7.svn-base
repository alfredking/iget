 ...
 * @return 密文对象
 */
- (MskResponse *)symmEncrypt:(int)index data:(NSString *)data;
 ...
 * @return 通用结果对象
 */
-(MskResponse *)asymmVerify:(int)index  fill_mode:(DATA_FILL_MODE)fill_mode hashID:(NSString *)hashID userID:(NSString *)userID data:(NSString *)data sign:(NSString *)sign;
