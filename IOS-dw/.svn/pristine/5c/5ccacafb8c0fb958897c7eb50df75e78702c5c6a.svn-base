...
#define domainWapURL DefaultNorthForwardwapURL
...
//#define logReportUrl @"http://218.205.115.245:10088/log/logReport"
//#define logReportUrl PIECEURL(@"/log/logReport")
#define logReportUrl DefaultLogReportURL
#define cleanSsoUrl PIECEURL(@"/client/synLifeTime")
#define tokenUrl PIECEURL(@"/api/tokenValidate")
...
//#define configsUrl @"http://218.205.115.242:30009/conf/client/getConfigs"
//#define configsUrl PIECEURL(@"/client/getConfigs")
#define configsUrl DefaultConfigURL


#define localUrl @"http://wap.cmpassport.com:8080/client/getWPMobile"
//#define localUrl @"http://218.205.115.243:10089/client/getWPMobile"
...
#define VOCclientversion @"VOC clientversion"
#define VUPclientversion @"VUP clientversion"
#define ksVUP_nonce @"VUP Nonce"
...
//公共文本
#define IDMPSetIsLogPrint  @"IDMPSetIsLogPrint"//设置日志是否打印到本地的键
...
#define sdkversionValue @"andidmp-iosv3.1.0"
...
//cleansso
#define cleanBTID @"btid"
#define cleanSqn @"sqn"
#define cleanPhoneID @"phoneId"
#define cleanQuery  @"query"
