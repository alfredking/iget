...
#define nowURL [[[NSUserDefaults standardUserDefaults] objectForKey:@"action_url"] isEqualToString:@"1"] ? [[NSUserDefaults standardUserDefaults] objectForKey:@"south_url"] : [[NSUserDefaults standardUserDefaults] objectForKey:@"north_url"]
#define port @""
#define SmsAccessNum @""
...
#define requestUrl PIECEURL(nowURL,port,@"/client/authRequest")
#define vcUrl PIECEURL(nowURL,port,@"/client/userManage")
#define qapUrl PIECEURL(nowURL,port,@"/client/queryAppPsd")
#define tokenUrl PIECEURL(nowURL,port,@"/api/tokenValidate")
#define appCheckUrl PIECEURL(nowURL,port,@"/client/ckRequest")
#define localUrl PIECEURL(nowURL,port,@"/client/getWPMobile")
...
#define sdkversionValue @"andidmp-iosv1.9.1"
