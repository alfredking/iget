...
//    _tableMain.hidden=YES;
    
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(actionTapView)];
    UITapGestureRecognizer *tabletap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tabletapview)];
    tap.delegate = self;
    [_backView addGestureRecognizer:tap];
//    [_tableMain addGestureRecognizer:tabletap];
...
//    _tableMain.delaysContentTouches = NO;
    ...
    for(UIGestureRecognizer *gestureRecognizer in _tableMain.gestureRecognizers) {
         NSLog(@"gestureRecognizers: %@",gestureRecognizer);
    }
}
