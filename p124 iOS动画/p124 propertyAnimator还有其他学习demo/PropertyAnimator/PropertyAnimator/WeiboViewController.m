...
//
// p125 UIViewPropertyAnimatorhttps://www.jianshu.com/p/6a9fe8e00326
//https://github.com/pro648/tips/wiki/UIViewPropertyAnimator%E7%9A%84%E4%BD%BF%E7%94%A8
...
- (void)setupAnimator {
    ...
    // 4.为动画添加完成块。
    WeiboViewController * __weak weakSelf = self;
    WeiboViewController *vc = weakSelf;
    if (vc) {
