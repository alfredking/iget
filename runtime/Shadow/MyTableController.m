...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        ...
        case 4:
            ...
            break;
        case 5:
            changeVc.shadowPathSide = LXShadowPathNoBottom;
            break;
        case 6:
            changeVc.shadowPathSide = LXShadowPathNoLeft;
            break;
        case 7:
            changeVc.shadowPathSide = LXShadowPathNoRight;
            break;
        case 8:
...
-(NSArray *)dataA{
    if (!_dataA) {
        _dataA  = @[@"顶部阴影",@"底部阴影",@"左侧阴影",@"右侧阴影",@"左右底部阴影",@"左右顶部阴影",@"右顶底部阴影",@"左顶底部阴影",@"四周"];
    }
    return _dataA;
}
