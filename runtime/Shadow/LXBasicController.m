...
- (void)viewDidLoad {
    ...
    switch (self.shadowPathSide) {
        ...
        case LXShadowPathNoBottom:
            [self.shaowView LX_SetShadowPathWith:[UIColor greenColor] shadowOpacity:0.3 shadowRadius:2 shadowSide:LXShadowPathNoBottom shadowPathWidth:10];
            break;
        case LXShadowPathNoLeft:
            [self.shaowView LX_SetShadowPathWith:[UIColor greenColor] shadowOpacity:0.3 shadowRadius:2 shadowSide:LXShadowPathNoLeft shadowPathWidth:10];
            break;
        case LXShadowPathNoRight:
            [self.shaowView LX_SetShadowPathWith:[UIColor greenColor] shadowOpacity:0.3 shadowRadius:2 shadowSide:LXShadowPathNoRight shadowPathWidth:10];
            break;
