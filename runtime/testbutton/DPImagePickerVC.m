...
//    self.collectionView =   [[UICollectionView alloc]initWithFrame:[UIScreen mainScreen].bounds collectionViewLayout:flow];
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64, screen_width, screen_height - 64) collectionViewLayout:flow];
...
//    [btn setImage:[UIImage imageNamed:@"back"] forState:(UIControlStateNormal)];
    ...
    [btn addTarget:self action:@selector(leftBarAction) forControlEvents:(UIControlEventTouchUpInside)];
    
    UIButton *btn1 = [UIButton new];
    [navView addSubview:btn1];
    btn1.frame = CGRectMake(150, 10, 50, 20);
    //    [btn setImage:[UIImage imageNamed:@"back"] forState:(UIControlStateNormal)];
    ...
    //    btn.titleEdgeInsets = UIEdgeInsetsMake(0, -35, 0, 0);
    //    btn.backgroundColor = [UIColor purpleColor];
    [btn1 addTarget:self action:@selector(rightBarAction) forControlEvents:(UIControlEventTouchUpInside)];
}
