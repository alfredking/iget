...
- (void)setUpFrames
{
    ...
    _scrollView.frame = CGRectMake(0, STATUSBAR_HEIGHT, kAPPWidth, kAppHeight - STATUSBAR_HEIGHT-SAFA_HEIGHT);
    
    CGFloat y = 0;
    __block CGFloat w = kAPPWidth - kPhotoBrowserImageViewMargin * 2;
    ...
    _indexLabel.center = CGPointMake(kAPPWidth * 0.5, STATUSBAR_HEIGHT + 5);
    _saveButton.frame = CGRectMake(30, kAppHeight - STATUSBAR_HEIGHT-SAFA_HEIGHT - 50, 55, 30);
}
...
- (void)showPhotoBrowser
{
    ...
    [UIView animateWithDuration:kPhotoBrowserShowDuration animations:^{
        ...
        self->_hasShowedPhotoBrowser = YES;
...
- (void)addScrollView
{
    ...
    _scrollView.frame = CGRectMake(0, 44, kAPPWidth, kAppHeight - STATUSBAR_HEIGHT);
...
- (void)addToolbars
{
    ...
    indexLabel.center = CGPointMake(kAPPWidth * 0.5, STATUSBAR_HEIGHT);
