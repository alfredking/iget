...
+ (instancetype)loopImageViewWithFrame:(CGRect)frame isHorizontal:(BOOL)isHorizontal isPageControl:(BOOL)isPageControl
{
    ...
    loopView.isPageControl = isPageControl;
...
- (void)refreshCurrentImageView
{
    ...
    if (self.changeBottomIndexBlock) {
        self.changeBottomIndexBlock(self);
    }
}
